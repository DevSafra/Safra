...
| Gap                                                               | Blocks                                                                      | Note                                                                                                                                                                                                                                                                                                            |
| ----------------------------------------------------------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ~~No `reviews` table, API or aggregate~~ — **shipped 2026-08-07** | The customer-facing write form in `apps/web`, and the sidebar's `4.7` badge | Schema, API, partner UI and staff moderation all exist. `properties.rating` is now a real aggregate maintained by trigger over published reviews, not a seeded column. See `O-partner-1`.                                                                                                                       |
