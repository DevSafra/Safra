...
export const ar = {
  ...
  'setting.value_localised_text':
    'يجب أن تكون الرسالة نصاً لكل لغة (العربية والإنجليزية والألمانية)، وبطول لا يتجاوز 120 حرفاً.',
  'payout.unsupported_payable':
    'يتضمّن هذا التحويل حجوزات لا يقابل استحقاقها قيدٌ في دفتر الأستاذ. لا يُطلق التحويل قبل معالجتها.',
  ...
  'catalogue.in_use':
    'يشير إليه {count} سجلاً، فلا يمكن حذفه — أوقفه بدل ذلك ليختفي من الخيارات الجديدة ويبقى ما يستخدمه سليماً.',
  'catalogue.code_format':
    'الرمز يُكتب بحروف لاتينية صغيرة وأرقام وشرطات فقط، مثل ev-charger.',
  'geo.category_in_use': 'الفئة مصنَّفة تحتها {n} من المدن — يمكن إيقافها بدل حذفها.',
  'geo.city_in_use':
    'لا يمكن حذف مدينة مرتبطة بـ {n} سجلاً (عقارات، حجوزات، شركاء…). أوقفها بدل حذفها.',
  'geo.country_in_use':
    'لا يمكن حذف دولة تحتوي على {n} مدينة. احذف مدنها أولاً أو أوقف الدولة.',
  'geo.currency_in_use': 'لا يمكن حذف عملة مستخدمة في {n} سجلاً. أوقفها بدل حذفها.',
  'geo.currency_accounting': 'عملة المحاسبة لا تُحذف — كل قيود الدفتر مقوَّمة بها.',
