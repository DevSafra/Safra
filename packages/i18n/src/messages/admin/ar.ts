  ...
  sections: {
    ...
    */
    ...
    disputes: {
      ...
      */
      evidenceShare: 'شارِك مع الشريك',
      evidenceShared: 'مُشارَك مع الشريك',
      evidenceSharing: 'جارٍ المشاركة…',
      evidenceShareTitle: 'مشاركة هذا الملف مع الشريك؟',
      evidenceShareMessage:
        'يصبح هذا الملف مرئيًّا للشريك داخل صفحة النزاع. شارِكه فقط إذا كان ضروريًّا لبتٍّ عادل — أدلة العميل خاصة افتراضيًّا، والمشاركة تُسجَّل في سجل التدقيق باسمك ولا يمكن التراجع عنها.',
      evidenceShareConfirm: 'نعم، شارِك الملف',
      evidenceShareFailed: 'تعذّرت المشاركة. حاول مرة أخرى.',
