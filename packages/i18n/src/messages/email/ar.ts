...
export const ar = {
  ...
  /*
    ── When a dispute is decided (Bashar, 2026-08-28) ───────────────────────

    Closing a dispute released the partner's frozen payout and could credit a customer's wallet, and
  ...
  */
  ...
  disputeRejected: {
    subject: 'قرار في نزاعك على الحجز {booking}',
    body: 'راجعنا شكواك على الحجز {booking}، ولم نجد ما يكفي لقبولها.\n\nرقم النزاع: {reference}\nتاريخ القرار: {date}\n\nالقرار:\n{resolution}\n\nإن كان لديك ما يضيف إلى الشكوى — صور أو رسائل أو أي تفصيل لم يصلنا — تواصل مع الدعم من حسابك ونحن نعيد النظر.\n\nالحجز والنزاع كاملان في حسابك:\n{url}\n\nفريق سفرة',
  },
