  ...
  return (
    ...
    >
      ...
      >
        ...
        */}
        <div className="flex shrink-0 items-center justify-between gap-3 px-3 py-3 text-14 text-white sm:px-4">
          <span className="flex min-w-0 flex-wrap items-center gap-x-3 gap-y-1">
            ...
            */}
            ...
            {current.badge ? (
              <span className="shrink-0 rounded-full bg-white/12 px-2 py-0.5 text-13 font-semibold text-gold-read ring-1 ring-white/15">
                {current.badge}
              </span>
            ) : null}
          </span>
        ...
        {images.map((image, index) => (
          <li key={image.id} className="relative">
            ...
            */}
            ...
            {image.badge ? (
              <span className="pointer-events-none absolute start-1 top-1 rounded-full bg-bg/85 px-2 py-0.5 text-13 text-gold-read ring-1 ring-gold/25">
                {image.badge}
              </span>
            ) : null}
          </li>
