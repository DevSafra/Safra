  ...
  */
  projects: [
    ...
    { name: 'setup', testMatch: /auth\.setup\.ts/ },
    {
      ...
      */
      testIgnore:
        /(partner|partner-images|partner-screens|partner-sidebar|partner-calendars|partner-employees|partner-suspension|customer-review|customer-invoices|customer-gifts|partner-support|auth-throttle|three-apps-together)\.spec\.ts/,
    },
    /**
