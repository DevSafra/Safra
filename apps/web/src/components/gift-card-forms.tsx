    ...
    <div className="grid gap-3 rounded-card border border-line bg-card p-5">
      ...
      */}
      {issued ? (
        ...
        >
          <p className="text-sm font-semibold text-gold-read">{t('giftCodeOnce')}</p>
          <p
            data-gift-code
            dir="ltr"
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="min-h-10 cursor-pointer rounded-lg border border-gold px-4 text-sm text-gold-read lg:min-h-0 lg:py-1.5"
            >
