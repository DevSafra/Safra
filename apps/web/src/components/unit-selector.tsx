            ...
            <div className="grid gap-4 sm:grid-cols-[1fr_auto] sm:items-start">
              <div className="min-w-0">
                ...
                */}
                <p className="mt-1 text-xs text-faint">
                  ...
                  {unit.maxNights === null ? '' : ` · ${copy.nightsMax(unit.maxNights)}`}
                </p>
                ...
                <div className="mt-3">
                  ...
                  {unit.amenityCodes.length > 0 ? (
                    ...
                    <p className="mt-1 text-[12.5px] text-faint">{copy.amenitiesNone}</p>
                  )}
                </div>
              </div>
              ...
              <div className="flex flex-col items-stretch gap-2 sm:w-44 sm:items-end">
                ...
                <Link
                  ...
                  */
                  href={`/${locale}/checkout?property=${propertySlug}&unitId=${unit.id}&checkIn=${stay.checkIn}&checkOut=${stay.checkOut}&adults=${Math.min(guests.adults, unit.maxGuests)}&children=${guests.children}&infants=${guests.infants}`}
