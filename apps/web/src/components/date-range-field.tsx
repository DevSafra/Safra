  ...
  */
  ...
  return (
    <div className="min-w-0">
      <p className="pb-2 text-center text-14 font-semibold text-text">
      ...
      <div className="grid grid-cols-7 gap-0.5">
        {Array.from({ length: 7 }, (_, index) => (
          ...
          <span key={index} className="grid h-7 place-items-center text-13 text-faint">
        ...
        {Array.from({ length: days }, (_, index) => {
          ...
          return (
            <button
              ...
              className={`grid h-8 w-full cursor-pointer place-items-center rounded-lg text-13 tabular-nums transition-[background-color,color] duration-150 ease-out-strong disabled:cursor-not-allowed disabled:text-faint/50 ${
                isStart || isEnd
                  ? 'btn-gold font-bold'
                  : inRange
                    ? 'bg-band text-text'
