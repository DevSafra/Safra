...
export function UnitCalendar({
  ...
  if (!unit) return <p className="text-14 text-faint">{t.unitCalendar.noUnits}</p>;
  ...
  return (
    <div className="grid gap-4">
      <div className="flex flex-wrap items-center gap-3">
        <p className="text-14 font-bold text-text">{unit.nameAr}</p>
        <p className="text-14 text-muted" dir="ltr">
