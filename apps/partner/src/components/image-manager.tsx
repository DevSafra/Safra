...
export function ImageManager({
  ...
  return (
    <div className="grid gap-3.5">
      <p className="text-13 leading-relaxed text-faint">{t.images.note}</p>
      ...
      <div className="flex flex-wrap items-center gap-3">
        <label className="inline-flex min-h-10 cursor-pointer items-center rounded-lg bg-[linear-gradient(135deg,#F0CB7C,#C4923E)] px-4 py-2 text-14 font-extrabold text-[#241A05] lg:min-h-0">
      ...
      */}
      ...
      {images.length === 0 ? (
        <p className="text-14 text-faint">{t.images.empty}</p>
      ) : (
            ...
            >
              <div className="relative h-[150px] bg-field">
                ...
                */}
                ...
                {image.isCover ? (
                  <span className="absolute top-2 start-2 rounded-full border border-gold bg-gold/20 px-2.5 py-0.5 text-13 font-bold text-gold-read">
                    {t.images.cover}
                  </span>
                ) : null}
              </div>
...
function AltEditor({
  ...
  return (
    ...
    >
      <p className="text-14 leading-relaxed text-faint">{t.images.altLabel}</p>
      ...
      <button
        type="submit"
        className="min-h-10 w-fit cursor-pointer rounded-lg border border-line px-3 py-1 text-13 text-muted lg:min-h-0"
      >
  ...
  return (
    <label className="grid gap-0.5">
      ...
      <input
        ...
        className="min-h-10 rounded-lg border border-line bg-field px-2.5 py-1.5 text-13 text-text lg:min-h-0"
      />
    </label>
  );
}
...
function Small({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className={`min-h-10 cursor-pointer rounded-lg border px-2.5 py-1 text-13 disabled:cursor-not-allowed disabled:opacity-40 lg:min-h-0 ${
