...
export function SuspensionNotice({
  ...
  return (
    ...
    >
      ...
      */}
      <p className="text-14 font-medium text-text">{t.suspension.guestsSafe}</p>

      <div className="grid gap-2 sm:grid-cols-2">
        <div className="grid gap-1">
          <h3 className="text-13 font-semibold text-muted">
            {t.suspension.blockedTitle}
          </h3>
          <ul className="grid gap-1 text-14 text-muted">
