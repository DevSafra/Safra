        ...
        {accounts.map((account) => (
          ...
          >
            <div className="flex flex-wrap items-center gap-2">
              <span
                data-status-pill
                className={`inline-flex items-center rounded-full px-2 py-0.5 text-14 font-semibold ${TONES[statusTone(account.status)]}`}
              >
            ...
            {account.status === 'rejected' && account.rejectionReason ? (
              <p className="rounded-lg border border-bad/40 bg-bad/5 px-3 py-2 text-13 leading-relaxed text-text">
      ...
      */}
      ...
      <div className="flex flex-wrap gap-2">
        <button
          type="submit"
          disabled={busy}
          className="inline-flex min-h-10 cursor-pointer items-center rounded-lg btn-gold px-4 text-14 font-semibold text-ink transition-colors duration-150 disabled:cursor-not-allowed disabled:opacity-50 lg:min-h-0 lg:py-2"
        >
          {c.save}
        </button>
...
function Action({
  ...
  return (
    <button
      ...
      className={`inline-flex w-fit min-h-10 cursor-pointer items-center rounded-lg border px-3 text-14 font-semibold transition-colors duration-150 disabled:cursor-not-allowed disabled:opacity-50 lg:min-h-0 lg:py-1.5 ${
        danger
