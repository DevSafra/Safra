...
export function CouponDecision({ code }: { readonly code: string }) {
  ...
  return (
    <div className="grid gap-2">
      ...
      <p className="text-13 leading-relaxed text-bad">{c.warning}</p>
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button
          ...
          className="inline-flex min-h-10 cursor-pointer items-center rounded-lg btn-gold px-4 py-2 text-xs font-bold text-ink transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50 lg:min-h-0"
        >
