...
export default async function DisputesPage() {
  ...
  */
  ...
  return shell(
    <>
      <p className="text-14 leading-relaxed text-muted">{t.disputes.intro}</p>
      ...
      {page.disputes.length === 0 ? (
        <p className="text-14 text-faint">{t.disputes.empty}</p>
      ) : (
            ...
            >
              ...
              */}
              ...
              >
                ...
                <p className="mt-1.5 text-14 text-text">{row.title}</p>
