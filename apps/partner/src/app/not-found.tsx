  ...
  return (
    <main className="mx-auto grid min-h-screen max-w-md place-content-center px-4">
      <div className="w-full text-center">
        ...
        <Link
          href="/"
          className="border-line bg-card text-gold-read hover:border-gold mt-8 inline-flex min-h-10 cursor-pointer items-center rounded-lg border px-4 text-sm lg:min-h-0"
        >
          {t.notFound.home}
        </Link>
      </div>
