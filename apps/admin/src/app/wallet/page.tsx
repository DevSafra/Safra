...
*/
const TEMPLATE = '1.2fr 1fr 1.05fr 1.05fr 1.45fr 1fr';
    ...
    render: (row) =>
      row.customerReference && row.customerActive ? (
        ...
        >
          ...
          <Ltr className="text-13 text-faint">{row.customerReference}</Ltr>
        </Link>
      ) : (
  ...
  },
  {
    ...
    render: (row) => (
      <div className="grid gap-0.5">
        ...
        <Ltr className="text-13 text-muted">{shortDateTime(row.at)}</Ltr>
      </div>
    ),
  },
];
