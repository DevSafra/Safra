    ...
    <ConsoleShell title={t.sections.staff.member.heading} counts={counts}>
      ...
      <div className="mt-4 grid gap-4">
        <ConsolePanel title={t.sections.staff.member.account}>
          ...
          */}
          <p className="mt-3 text-14 leading-relaxed text-faint">
          ...
          */}
          {isScopable(member.role as Role) ? (
            <div className="mt-4 border-t border-line2 pt-4">
              <h3 className="mb-2.5 text-14 font-bold text-gold-read">
          ...
          {member.staffRoleId === null ? (
            <p className="mt-3 text-13 text-warn">
        ...
        */}
        ...
        <ConsolePanel title={t.sections.staff.member.capabilities}>
          ...
          {member.permissions.length === 0 ? (
            <p className="text-14 text-faint">{t.sections.staff.member.noCapabilities}</p>
          ) : (
            <div className="grid gap-3">
              ...
              */}
              {groupPermissions(member.permissions).map((entry) => (
                <div key={entry.group}>
                  <h3 className="text-13 font-bold text-faint">
                    {label(t.sections.staffRoles.group, entry.group)}
                  </h3>
                  <p className="mt-1 text-14 leading-relaxed text-text2">
                    {entry.permissions
                      .map((permission) =>
  ...
  */
  ...
  return (
    <div className="min-w-0">
      ...
      <dd
        className="mt-0.5 text-14 text-text"
