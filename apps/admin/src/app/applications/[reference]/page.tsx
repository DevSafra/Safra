  ...
  return (
    <Shell reference={reference} back={back}>
      ...
      <Section title={c.business}>
        ...
        {application.message ? (
          <div className="mt-2 rounded-lg border border-line bg-card px-4 py-3">
            ...
            <p className="mt-1 whitespace-pre-wrap text-14 leading-relaxed text-text">
              {application.message}
            </p>
          </div>
        ) : null}
      ...
      <Section title={t.table.colStatus}>
        ...
        />
        <p className="mt-3 rounded-lg border border-dashed border-line px-3 py-2 text-13 leading-relaxed text-faint">
          {c.afterAccept}
        </p>
      </Section>
    </Shell>
...
function Row({
  ...
  return (
    <div className="rounded-lg border border-line bg-card px-4 py-3">
      <p className="text-13 text-faint">{name}</p>
      <p className="mt-1 text-14 text-text">{value}</p>
    </div>
  );
}
  ...
  return (
    <li className="rounded-lg border border-line bg-card px-4 py-3">
      <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
        <span className="text-14 font-semibold text-text">{title}</span>
        <span className="text-13 text-faint">
      ...
      {notes ? (
        <p className="mt-1 whitespace-pre-wrap text-14 leading-relaxed text-text2">
          {notes}
        </p>
      ) : null}
    </li>
