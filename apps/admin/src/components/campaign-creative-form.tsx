...
export function CampaignCreativeForm({
  ...
  */
  ...
  const field =
    'w-full min-w-0 rounded-lg border border-line bg-field px-3 py-2 text-14 text-text';
  const labelled = 'grid gap-1.5 text-13 font-semibold text-muted';
  ...
  return (
    <>
      <button
        ...
        type="button"
        onClick={() => reopen()}
        className="inline-flex w-full cursor-pointer items-center justify-center whitespace-nowrap rounded-lg border border-line px-2.5 py-1 text-13 text-muted transition-colors hover:border-[rgba(var(--goldA),0.5)] hover:text-gold-read"
      >
        {c.editCreative}
      </button>
        ...
        >
          ...
          >
            <div className="mb-4 flex items-start justify-between gap-4">
              <h2 className="text-16 font-bold text-text">{c.editTitle}</h2>
              <button
                type="button"
                onClick={() => dismiss()}
            ...
            <div className="grid gap-3.5">
              ...
              */}
              ...
              <div className={labelled}>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  {staged.kind === 'remove' ? (
                    ...
                    <span className="grid h-20 w-32 content-center gap-1 rounded-lg border border-dashed border-line px-2 text-center text-13 text-muted">
                    ...
                    /*
                      ...
                      shows only that.
                    */
                    <span className="grid h-20 w-32 content-center gap-1 rounded-lg border border-dashed border-[rgba(var(--goldA),0.55)] px-2 text-center text-13 text-gold-read">
                    ...
                    */
                    ...
                    <span className="grid h-20 w-32 place-items-center rounded-lg border border-dashed border-line px-2 text-center text-13 text-faint">
                  ...
                  <div className="grid gap-1.5">
                    <button
                      ...
                      className="inline-flex min-h-10 w-fit cursor-pointer items-center rounded-lg border border-line px-4 py-2 text-13 text-muted transition-colors hover:border-[rgba(var(--goldA),0.4)] hover:text-gold-read disabled:opacity-50 lg:min-h-0"
                    >
                    ...
                    */}
                    {imageStatus !== null && staged.kind === 'none' ? (
                      <button
                        ...
                        className="w-fit cursor-pointer text-13 font-normal text-muted underline transition-colors hover:text-bad disabled:opacity-50"
                      >
                        {c.imageRemove}
                      </button>
                    ) : null}
                    ...
                    {staged.kind === 'none' ? (
                      ...
                      <button
                        ...
                        className="w-fit cursor-pointer text-13 font-normal text-muted underline transition-colors hover:text-gold-read disabled:opacity-50"
                      >
                        {staged.kind === 'remove'
                          ? c.imageRemoveUndo
              ...
              {error ? <p className="text-13 font-semibold text-bad">{error}</p> : null}
