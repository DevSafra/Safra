  ...
  return (
    <div className="mt-2 rounded-lg border border-gold/30 bg-gold/5 px-3 py-2.5">
      ...
      <button
        ...
        disabled={busy}
        onClick={() => void resend()}
        className="mt-2 inline-flex min-h-10 cursor-pointer items-center rounded-lg border border-gold/40 px-3 py-1.5 text-13 font-semibold text-gold-read hover:bg-gold/10 disabled:cursor-not-allowed disabled:opacity-60 lg:min-h-0"
      >
        {busy
