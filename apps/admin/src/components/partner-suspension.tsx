  ...
  return (
    <div className="grid gap-3">
      {suspension ? (
        ...
        >
          <p className="text-14 font-extrabold text-bad">
          ...
          <dl className="mt-3 grid gap-2 sm:grid-cols-2">
            <div className="min-w-0 sm:col-span-2">
              <dt className="text-13 text-faint">
            ...
            <div className="min-w-0">
              ...
              <dd className="mt-0.5 text-14 text-text2">
                {suspension.by
          ...
          */}
          {suspension.notes ? (
            <div className="mt-3 rounded border border-line bg-field p-2.5">
              ...
              <p className="mt-0.5 text-13 text-text2">{suspension.notes}</p>
            </div>
          ) : null}
        </div>
      ) : null}
