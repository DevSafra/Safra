    ...
    return (
      <div className="mt-3 flex">
        <button
          ...
          className="cursor-pointer rounded-lg border border-[rgba(var(--goldA),0.4)] px-4.5 py-2 text-xs font-bold text-gold-read transition-colors hover:bg-[rgba(var(--goldA),0.08)]"
        >
