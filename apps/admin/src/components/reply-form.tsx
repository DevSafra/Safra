    ...
    <div className="grid gap-2.5">
      <label className="grid gap-1.5">
        ...
        <textarea
          ...
          className="rounded-lg border border-line bg-field px-3 py-2.5 text-14 leading-relaxed text-text placeholder:text-faint"
        />
      </label>

      <label className="flex cursor-pointer items-center gap-2.5 text-13 text-text2">
        <input
          type="checkbox"
          checked={internal}
      ...
      {willRedact ? (
        <p className="text-14 text-warn">{t.sections.messages.redactionNote}</p>
      ) : null}
