      ...
      <div className="flex flex-wrap items-center gap-2.5">
        ...
        >
          ...
          */}
          <button
            type="submit"
            className="inline-flex min-h-10 cursor-pointer items-center rounded-lg border border-line px-3.5 py-2 text-[14px] text-muted transition-colors hover:border-[rgba(var(--goldA),0.4)] hover:text-gold-read"
          >
            {t.table.search}
          </button>
        </form>
...
export function OutlineAction({
  ...
  return (
    <a
      href={href}
      {...(download ? { download: '' } : {})}
      className="inline-flex min-h-10 cursor-pointer items-center rounded-lg border border-[rgba(var(--goldA),0.35)] px-4 py-1.5 text-xs font-bold text-gold-read transition-colors hover:bg-[rgba(var(--goldA),0.08)]"
    >
      {children}
    </a>
  );
...
export function GoldAction({
  ...
  return (
    <a
      href={href}
      className="inline-flex min-h-10 cursor-pointer items-center rounded-lg bg-[linear-gradient(135deg,#F0CB7C,#C4923E)] px-5 py-2 text-[14px] font-extrabold text-[#241A05] transition-opacity hover:opacity-90"
    >
      {children}
    </a>
  );
