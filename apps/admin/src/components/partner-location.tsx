...
export function PartnerLocation({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-end gap-2">
        <label className="grid gap-1 text-13 text-faint">
          ...
          <input
            ...
            placeholder="33.5138"
            disabled={busy}
            className="min-h-10 w-32 rounded-lg border border-line bg-field px-3 py-2 text-14 text-text disabled:cursor-not-allowed lg:min-h-0"
          />
        </label>
      ...
      {saved && !error ? (
        <p role="status" className="text-13 text-ok">
          {copy.saved}
        </p>
      ) : null}
    </form>
