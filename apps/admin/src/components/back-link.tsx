  ...
  return (
    ...
    */
    <BackNavigation
      ...
      className="inline-flex min-h-10 cursor-pointer items-center gap-1.5 rounded-lg border border-line px-3.5 py-2 text-[14px] text-muted transition-colors hover:border-[rgba(var(--goldA),0.4)] hover:text-gold-read lg:min-h-0"
    >
