      ...
      */}
        ...
        */}
        ...
        <fieldset className="grid gap-1.5">
          <legend className="text-13 font-semibold text-muted">
            {c.categoriesLabel}
          </legend>
        ...
        <div className="grid gap-1.5 border-t border-line pt-3">
          <span className="text-13 font-semibold text-muted">{c.images}</span>
          ...
          */}
          ...
          <p className="text-14 text-faint">{c.imagesNote}</p>
        </div>
            ...
            render: (row) => (
              <span className="flex items-center gap-2">
                ...
                <span
                  ...
                  className={`text-13 ${row.images === 0 ? 'text-bad' : 'text-faint'}`}
                >
                  {row.images === 0
                    ? c.imagesNone
