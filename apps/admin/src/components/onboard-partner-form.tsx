...
export function OnboardPartnerForm({
  ...
  return (
    ...
    >
      <p className="rounded-lg border border-gold/30 bg-gold/5 px-4 py-3 text-14 leading-relaxed text-gold-read">
      ...
      <Fieldset legend={t.sections.partnerOnboarding.businessSection}>
        ...
        <div className="grid gap-1.5">
          ...
          <select
            ...
            className="cursor-pointer rounded-lg border border-line bg-field px-3 py-2.5 text-14 font-normal text-text"
          >
        ...
        <div className="grid gap-1.5">
          ...
          <span
            ...
            className="text-13 font-normal text-faint"
          >
      ...
      <div className="grid gap-1.5">
        <label htmlFor={`${formId}-notes`} className="text-13 font-semibold text-muted">
        ...
        <textarea
          ...
          className={`rounded-lg border bg-field px-3 py-2.5 text-14 font-normal text-text ${
            field === 'notes' ? 'border-bad' : 'border-line'
          }`}
        />
        <span id={`${formId}-notes-hint`} className="text-13 font-normal text-faint">
...
function Fieldset({ legend, children }: { legend: string; children: React.ReactNode }) {
  return (
    <fieldset className="grid gap-3 rounded-lg border border-line bg-card p-4 sm:grid-cols-2">
      <legend className="px-1 text-13 font-semibold text-text">{legend}</legend>
      {children}
    </fieldset>
  );
}
  ...
  return (
    <div className="grid gap-1.5">
      ...
      <input
        ...
        className={`min-h-10 rounded-lg border bg-field px-3 py-2.5 text-14 font-normal text-text lg:min-h-0 ${
          invalid ? 'border-bad' : 'border-line'
        }`}
      />
      {hint ? (
        <span id={hintId} className="text-13 font-normal text-faint">
          {hint}
        </span>
      ) : null}
    </div>
