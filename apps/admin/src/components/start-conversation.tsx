      ...
      */}
      <label className="grid gap-1.5 text-13 font-semibold text-muted">
        ...
        <input
          ...
          className="rounded-lg border border-line bg-card px-3 py-2 text-14 text-text placeholder:text-faint"
        />
        <span className="text-13 font-normal text-faint">{c.composeReferenceHint}</span>
      </label>
      ...
      <p className="text-14 leading-relaxed text-faint">{c.composeNote}</p>
