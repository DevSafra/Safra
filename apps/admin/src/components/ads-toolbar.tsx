...
export function AdsToolbar({
  ...
  */
  ...
  const field = 'rounded-lg border border-line bg-card px-3 py-2 text-14 text-text';
  ...
  const panel =
    open === 'advertiser' ? (
      <div className="grid w-full gap-3 rounded-card border border-line bg-field p-3.5">
        <h3 className="text-14 font-bold text-text">{c.advTitle}</h3>
        ...
        {created ? (
          <p className="text-13 font-semibold text-gold-read">
      ...
      <div className="grid w-full gap-3 rounded-card border border-line bg-field p-3.5">
        <h3 className="text-14 font-bold text-text">{c.newTitle}</h3>
        ...
        panel === null ? (
          <>
            <button
              ...
              className="min-h-10 cursor-pointer rounded-lg border border-line px-4 py-1.5 text-14 font-bold text-muted transition-colors hover:border-[rgba(var(--goldA),0.4)] hover:text-gold-read lg:min-h-0"
            >
              {c.newAdvertiser}
            </button>
            <button
