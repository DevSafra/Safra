  ...
  */
  ...
  return (
    <nav
      ...
      */
      className="mt-3.5 scroll-mt-24 flex flex-wrap items-center justify-center gap-x-6 gap-y-2.5 border-t border-line pt-3.5 text-13 text-muted"
    >
      {/*
        ...
        */}
        ...
        <span className="flex items-center gap-2">
          ...
          <input
            ...
            */
            disabled={onlyPage}
            className="w-14 rounded-lg border border-line bg-field px-2 py-1.5 text-center text-14 text-text disabled:cursor-not-allowed disabled:opacity-40"
          />
        ...
        <label className="flex items-center gap-2">
          ...
          <select
            ...
            disabled={sizeIsMoot}
            className="cursor-pointer rounded-lg border border-line bg-field px-2 py-1.5 text-14 text-text disabled:cursor-not-allowed disabled:opacity-40"
          >
        ...
        <button
          ...
          className="inline-flex min-h-10 cursor-pointer items-center rounded-lg border border-line px-3 py-1.5 text-13 text-muted transition-colors hover:border-[rgba(var(--goldA),0.4)] hover:text-gold-read disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:border-line disabled:hover:text-muted"
        >
          {t.table.apply}
        </button>
      </PagerForm>
...
function Step({
  ...
  */
  const shape =
    'inline-flex h-10 w-10 items-center justify-center rounded-lg border text-16 leading-none lg:h-8 lg:w-8';
