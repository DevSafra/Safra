  ...
  return (
    <div className="mb-4 grid gap-2">
      ...
      <button
        ...
        className="inline-flex min-h-10 w-fit cursor-pointer items-center rounded-[9px] border border-gold/50 px-4 py-2 text-[12.5px] font-bold text-gold hover:bg-gold/10 lg:min-h-0"
      >
