  ...
  return (
    <section data-sanctions className="grid gap-3">
      <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
        <h2 className="text-16 font-extrabold text-gold-read">{c.sanctionsTitle}</h2>
        ...
        */}
        <span
          className={`ms-auto text-13 font-bold ${
      ...
      <p className="text-13 leading-relaxed text-text2">{c.sanctionsNote}</p>
      <p className="text-13 text-faint">{policyLine}</p>

      {status.imported ? (
        <dl className="grid gap-2 text-14 sm:grid-cols-3">
      ...
      <div className="grid gap-2 border-t border-line pt-3 sm:grid-cols-[1fr_auto_auto] sm:items-end">
        <label className="grid gap-1.5 text-13 font-semibold text-muted">
          ...
          <input
            ...
            className="min-h-10 cursor-pointer rounded-lg border border-line bg-field px-3 py-2 text-13 text-text file:me-3 file:cursor-pointer file:rounded-md file:border-0 file:bg-[rgba(var(--goldA),0.14)] file:px-3 file:py-1.5 file:text-13 file:font-bold file:text-gold-read lg:min-h-0"
          />
          <span className="text-13 font-normal text-faint">{c.sanctionsUploadHint}</span>
        </label>
        ...
        <label className="grid gap-1.5 text-13 font-semibold text-muted">
          ...
          <select
            ...
            className="min-h-10 cursor-pointer rounded-lg border border-line bg-field px-3 text-14 text-text lg:min-h-0"
          >
            {/*
        ...
        <button
          ...
          disabled={busy}
          className="inline-flex min-h-10 w-fit cursor-pointer items-center rounded-lg border border-[rgba(var(--goldA),0.4)] bg-[rgba(var(--goldA),0.06)] px-3 text-14 font-bold text-gold-read transition-transform duration-150 ease-out active:scale-[0.98] disabled:cursor-default disabled:opacity-60 lg:min-h-0 lg:py-1.5"
        >
