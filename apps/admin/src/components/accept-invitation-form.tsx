    ...
    return (
      <div className="rounded-lg border border-ok/40 bg-ok/10 p-4">
        ...
        <button
          ...
          className="cursor-pointer mt-4 rounded-lg btn-gold px-4 py-2 text-sm font-semibold text-ink"
        >
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        disabled={submitting}
        className="cursor-pointer rounded-lg btn-gold px-4 py-2 text-sm font-semibold text-ink disabled:cursor-not-allowed disabled:opacity-60"
      >
        {submitting
