  ...
  */
  ...
  return (
    <section className="grid gap-4">
      <p className="text-14 text-muted">{copy.intro}</p>
      ...
      >
        <label className="grid gap-1">
          <span className="text-13 text-faint">{copy.referenceLabel}</span>
          ...
          <input
            ...
            disabled={busy}
            className="min-h-10 w-64 rounded-lg border border-line bg-field px-3 py-2 text-14 text-text disabled:cursor-not-allowed lg:min-h-0"
          />
          <span className="text-13 text-faint">{copy.referenceHint}</span>
        </label>
      ...
      {sentTo ? (
        ...
        >
          ...
          <label className="grid gap-1">
            <span className="text-13 text-faint">{copy.codeLabel}</span>
            {/*
            ...
            */}
            <input
              ...
              maxLength={6}
              disabled={busy}
              className="min-h-10 w-32 rounded-lg border border-line bg-field px-3 py-2 text-center text-16 tracking-[0.3em] text-text disabled:cursor-not-allowed lg:min-h-0"
            />
          </label>
      ...
      {verified ? (
        <div className="grid gap-2 rounded-lg border border-ok/40 bg-ok/10 p-4">
          ...
          <Link
            ...
            className="inline-flex min-h-10 w-fit items-center text-14 text-sky hover:underline lg:min-h-0"
          >
            <Ltr>{verified}</Ltr>
        ...
        <p className="text-14 text-faint">{copy.sealed}</p>
      )}
    </section>
  );
}
