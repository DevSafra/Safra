  ...
  if (!open) {
    return (
      <button
        ...
        className="min-h-10 cursor-pointer rounded-lg border border-line px-2.5 py-1 text-13 font-bold text-muted transition-colors hover:border-bad hover:text-bad lg:min-h-0"
      >
        {c.cancel}
      </button>
    );
  ...
  return (
    <div className="grid gap-1.5">
      <textarea
        ...
        className="rounded-lg border border-line bg-card px-2.5 py-1.5 text-13 text-text"
      />
      <span className="text-13 text-faint">{c.cancelReasonHint}</span>
      ...
      <div className="flex flex-wrap gap-1.5">
        <button
          ...
          onClick={() => void submit()}
          className="min-h-10 cursor-pointer rounded-lg border border-bad px-2.5 py-1 text-13 font-bold text-bad disabled:cursor-not-allowed disabled:opacity-50 lg:min-h-0"
        >
        ...
        <button
          ...
          className="min-h-10 cursor-pointer rounded-lg border border-line px-2.5 py-1 text-13 font-bold text-muted lg:min-h-0"
        >
          {c.cancelBack}
        </button>
      </div>
