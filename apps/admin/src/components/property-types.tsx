    ...
    <div className="grid gap-3">
      <ul className="grid gap-1.5">
        {types.map((type) => (
          ...
          >
            ...
            */}
            <span className="min-w-0 text-14 text-text">
              {type.nameAr}
              {type.isActive ? null : (
                <span className="ms-2 text-13 text-faint">{copy.retired}</span>
              )}
            </span>
      ...
      {open ? (
        ...
        >
          ...
          <div className="flex gap-2">
            <button
              type="submit"
              disabled={busy}
              className="min-h-10 cursor-pointer rounded-lg border border-line px-4 text-14 text-text disabled:cursor-not-allowed lg:min-h-0"
            >
            ...
            <button
              ...
              className="min-h-10 cursor-pointer px-3 text-14 text-muted lg:min-h-0"
            >
              {copy.cancel}
            </button>
          </div>
        ...
        <button
          ...
          className="min-h-10 w-fit cursor-pointer rounded-lg border border-line px-4 text-14 text-text lg:min-h-0"
        >
          {copy.add}
        </button>
      )}
...
function Field({
  ...
  return (
    <label className="grid gap-1 text-13 text-faint">
      {label}
      <input
        name={name}
        required
