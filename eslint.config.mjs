...
export default tseslint.config(
  {
    ignores: [
      ...
      '**/next-env.d.ts',
      '**/next.config.js',
      // Runner scripts (`scripts/`), which are plain Node ESM outside any tsconfig project.
      //
      // Type-aware linting needs a project to check against, and these belong to no workspace
      // package — the same position `load/**` is in below. Prettier still formats them and
